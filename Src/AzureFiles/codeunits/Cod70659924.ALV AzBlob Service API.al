codeunit 70659924 "ALV AzBlob Service API"
{

    procedure ListContainers(var containers: Record "ALV AzConnector BlobContainer" temporary): Boolean
    var
    ...
    procedure ListBlobs(containerName: Text; var blobs: Record "ALV AzConnector BlobStorage" temporary): Boolean
    var
        blobStorageAccount: Record "ALV AzConnector Configuration";
        client: HttpClient;
        response: HttpResponseMessage;
