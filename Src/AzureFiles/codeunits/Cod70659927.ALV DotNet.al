codeunit 70659927 "ALV EncDecB64"
{
    ...
    begin
        ...
        tempblob.Init();
        tempblob.Insert();
        tempblob.Blob.CreateOutStream(oStream, TextEncoding::UTF16);
        oStream.WriteText(textFromInStream);
        tempblob.Blob.CreateInStream(iStream, TextEncoding::UTF16);
        //ReturnValue := TextToBase64String(textFromInStream);
        ReturnValue := StreamToBase64String(iStream);
    end;
    ...
    begin
        //https://www.kauffmann.nl/2017/07/10/convert-base64-with-al-code/
        //byte[] convertedBytesToB64 = Convert.FromBase64String(textFromInStream);
        //string decodedString = Encoding.Unicode.GetString(convertedBytesToB64);
        ReturnValue := FromBase64StringToText(textFromInStream);
    end;
